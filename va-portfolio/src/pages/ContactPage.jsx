...
const contactDetails = [
  ...
  {
    label: "WHATSAPP",
    value: "+234 916 299 9162",
    href: "https://wa.me/2349162999162",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52 -.075-.149-.669-1.612-.916-2.207 -.242-.579 -.487 -.5 -.669 -.51 -.173 -.008 -.371 -.01 -.57 -.01 -.198 0 -.52 .074 -.792 .372 -.272 .297 -1.04 1.0１６ -１．０４ ２．４７９ ０ １．４６２ １．０６５ ２．８７５ １．２１３ ３．０７４ .１４９ .１９８ ２．０９６ ３．２ ５．０７７ ４．４８７ .７０９ .３０６ １．２６２ .４８９ １．６９４ .６２５ .７１２ .２２７ １．３６ .１９５ １．８７１ .１１８ .５７１ -.０８５ １．７５８ -.７１９ ２．００６ -１．４１３ .２４８ -.６９４ .２４８ -１．２８９ .１７３ -１．４１３ -.０７４ -.₁₂₄ -.₂₇₂ -.₁₉₈ -.₅₇₋ .₃₄₇ m -５．₄₂₁ ７．₄₀₃ h -．₀₀４ a ９．８７ ９．８７ ₀ ₀ ₁ -５．₀³¹ -₁．₃₇₈ l -．³⁶¹ -．²¹⁴ -³．⁷⁴¹ .⁹⁸² .⁹⁹⁸ -³．⁶⁴⁸ -．²³⁵ -．³⁷⁴ a ９．８６ ９．８６ ₀ ₀ ₁ -₁．五百一 -５．²六 c .₀₀₁ -５．四五 四点四三六 -九点八八四 点八八八八九 四点一三 六点九八八 a nine point eight two five nine point eight two five zero one one point four four five l zero point zero五七二四 six point three零五负一点六五四 a eleven point eight eight two eleven point eight eight two zero zero five c six point six八三 one point four四八 h zero point zero零五 c six点五五四 zero one one点八九 ten点eight nine three a eleven point eight two one eleven point eight two one zero zero zero three z" />
      </svg>
    ),
  },
  {
      ...
      {mobile ? (
        ...
        >
          ...
          <motion.div {...fadeUp(0)}>
            ...
            <p style={{ fontSize: "13px", lineHeight: 1.75, color: "#71717a" }}>
              Whether you need someone to take operations off your plate, manage
              your calendar, or build your systems — I'm ready.
            </p>
          </motion.div>
          ...
          <AnimatePresence mode="wait">
            {sent ? (
              ...
              >
                ...
                >
                  Fego will get back to you within 24 hours.
                </p>
                <button
                  onClick={() => {
                    setSent(false);
        ...
        <div className="absolute inset-0 grid grid-cols-12 pt-16 pb-12 px-10">
          ...
          >
            <motion.div {...fadeUp(0)}>
              ...
              >
                Whether you need someone to take operations off your plate,
                manage your calendar, or build your systems from the ground up —
                I'm ready.
              </p>
            </motion.div>
            <motion.div
          ...
          <div className="col-span-6 flex flex-col justify-center pl-6">
            <AnimatePresence mode="wait">
              {sent ? (
                ...
                >
                  ...
                  >
                    Thanks for reaching out. Fego will get back to you within 24
                    hours.
                  </p>
                  <button
                    onClick={() => {
            ...
            <style>{`input::placeholder,textarea::placeholder{color:#52525b}input,textarea{color-scheme:dark}`}</style>
          </div>
        </div>
      )}
    </section>
